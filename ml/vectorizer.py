...
import numpy as np
from data_loader import load_users, load_posts, load_likes, load_bookmarks
...
def preprocess_posts(posts_df, users_df):
    ...
    post_features["length"] = posts_df["length"].values
...
def prepare_data():
    ...
    return user_vectors, post_vectors, interactions_df
